            ...
            <div class="relative flex flex-wrap">
                        ...
                        <form method="post" action="/forgot-password" class="mt-8">
                            ...
                            <div class="mx-auto max-w-lg">
                                <div class="py-2" x-data="{ show: true }">
                                    ...
                                    <div class="relative">
                                        <input placeholder="" name="email" type="email" value="{{$_GET['email']}}" class="text-md block px-3 py-2 rounded-lg w-full
                ...
                focus:outline-none">
                                ...
                                <div class="py-2" x-data="{ show: true }">
                                    ...
                                    <div class="relative">
                                        <input placeholder="" name="password" :type="show ? 'password' : 'text'" class="text-md block px-3 py-2 rounded-lg w-full
                bg-white border-2 border-gray-300 placeholder-gray-600 shadow-md
                focus:placeholder-gray-500
                focus:bg-white
                focus:border-gray-600
