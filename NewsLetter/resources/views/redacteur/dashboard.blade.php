...
<div class="flex">
    ...
    <div
        class="px-8 h-full w-full flex flex-col">
        <div class="bg-blue-200 shadow-lg pb-3 top-0 rounded-b-3xl">
            <div
                class="flex  rounded-b-3xl bg-gray-100 dark:bg-gray-700 space-y-5 flex-col items-center py-7">
                <img class="h-28 w-28 rounded-full border-2 border-blue-700"
                     src="{{ Auth::user()->picture }}"
                     alt="User">
                <a href="#"> <span
                        class="text-h1">{{ Auth::user()->name }}</span></a>
            </div>
            <div
        ...
        <div
            ...
            <div class="col-span-1 bg-blue-50 p-3">
                <div class="flex  flex-col items-center ">
                    <a href="">
                        <button class="tr-300">
                            <svg xmlns="http://www.w3.org/2000/svg"
