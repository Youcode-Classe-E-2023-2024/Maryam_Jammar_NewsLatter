        ...
        <main>
            ...
            <div class="flex justify-end w-26 ">
                <button
                    ...
                    <svg class="w-4 h-4 mr-2 transform rotate-180" xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 20 20">
                ...
                <div class="grid grid-cols-3 gap-6">
                    <div class="group pb-24 relative overflow-hidden">
                        ...
                        <img src="https://picsum.photos/300/300"
                             class="transition-all group-hover:scale-125 duration-700 mr-4 h-60 w-auto" alt="">
                        <div
                            ...
                            <h2 class="font-bold">Bob haris</h2>
                            <span class="text-black">Sales executive</span>
                        </div>
                    </div>
                    ...
                    <div class="group pb-24 relative overflow-hidden">
                        <div
                            class="group-hover:translate-y-0 transition-all duration-700 translate-y-full top-0 right-0 bottom-24 left-0 absolute bg-gradient-to-b from-transparent to-orange-600 z-10"></div>
                        <img src="https://picsum.photos/300/300"
                             class="absolute transition-all group-hover:scale-125 duration-700 mr-4 h-60 right-0"
                             alt="">
                        <div
                            class="bg-orange-600 absolute z-10 bottom-0 left-0 w-full h-24 flex flex-col justify-center items-center">
                            <div class="z-20 absolute -top-5 w-full flex justify-center">
